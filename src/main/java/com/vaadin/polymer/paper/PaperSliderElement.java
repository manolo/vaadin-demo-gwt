...
import com.vaadin.polymer.iron.event.IronFormElementRegisterEvent;
import com.vaadin.polymer.iron.event.IronFormElementUnregisterEvent;
import com.vaadin.polymer.paper.event.ImmediateValueChangeEvent;
import com.vaadin.polymer.paper.event.ValueChangeEvent;
...
public interface PaperSliderElement extends HTMLElement {
    ...
    @JsOverlay public static final String[] EVENTS = new String[]{
        ImmediateValueChangeEvent.NAME,
        ValueChangeEvent.NAME,
        IronFormElementRegisterEvent.NAME,
        IronFormElementUnregisterEvent.NAME
    };
